...
@implementation UITextField (Ado)
...
- (void)setAdo_maxInputLength:(NSInteger)ado_maxInputLength {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(textFieldCheckInputLength:) name:UITextFieldTextDidChangeNotification object:nil];
}

- (void)textFieldCheckInputLength:(UITextField *)textField {
